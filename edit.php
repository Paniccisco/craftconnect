...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="userhome.php"><img src="images/favicon2.png" alt="alternative"></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="userhome.php">Home</a><i class="fa fa-angle-double-right"></i><span>Profile</span>
    ...
    <script src="username_checker.js"></script>
</body>
