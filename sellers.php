                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrumbs">
                                <a href="adminhome.php">Home</a><i class="fa fa-angle-double-right"></i><span>All Sellers</span>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="users">
                                            ...
                                            if (isset($_GET['search'])) {
                                                ...
                                                $query = "SELECT * FROM sellers WHERE status = 'approved' AND CONCAT(fname, mobile, username, businessname, location, typeofcraft) LIKE '%$filtervalues%' ";
