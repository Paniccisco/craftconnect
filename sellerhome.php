    ...
    <?php if ($user) { ?>
        ...
        <body data-spy="scroll" data-target=".fixed-top">
            ...
            <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="sellerhome.php"><img src="images/favicon2.png" alt="alternative">islandhopper</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="sellermessage.php">Messages</a>
        ...
        <section id="features">
            ...
            <script>
                ...
                // Fetch seller locations from the server
