...
$(document).ready(function() {
    $('#changePasswordForm').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Handle success response, e.g., show success message, close modal, etc.
                // For example, you can reload the page or show a success message
                alert('Password changed successfully!');
                $('#changePasswordModal').modal('hide'); // Hide modal after successful password change
    ...
    function filterartisan() {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            var title = rows[i].getElementsByTagName('td')[3];
            var title = rows[i].getElementsByTagName('td')[4];
    ...
    $(document).ready(function() {
        ...
        $('.approveBtn').click(function() {
            ...
            var sellerName = $(this).closest('tr').find('td:eq(1)').text(); // Get seller name from the table row
            $('#sellerName').text(sellerName); // Set seller name in modal body
    ...
    // If the success parameter is present and set to true, show the success modal
