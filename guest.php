        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ordersModalLabel">Login Required</h5>
                ...
                <div class="modal-footer">
                    ...
                    <!-- Add any other buttons you may need, such as a button to redirect to the login page -->
                ...
                .then(data => {
                    data.forEach(seller => {
                        L.marker([seller.latitude, seller.longitude])
                            .addTo(map)
                            .bindPopup(`
                            <b>Business Name: </b>${seller.businessname}</b><br>
                            <b>Type of Craft: </b>${seller.typeofcraft}</b><br>
                            <b>Address: </b>${seller.location}</b><br>
                            <b><a href="#" data-toggle="modal" data-target="#ordersModal">See more details</a></b><br>    
                            `);
