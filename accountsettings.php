...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (password_verify($currentPassword, $user['password'])) {
        ...
        if ($newPassword === $confirmPassword) {
            ...
            header("Location: accountsettings.php?success=true");
            exit;
        } else {
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="adminhome.php"><img src="images/favicon2.png" alt="alternative"></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="adminhome.php">Home</a><i class="fa fa-angle-double-right"></i><span>Account Settings</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section id="booking-form">
                        <form class="shadow w-450 p-3" action="php/adminedit.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="elem-group">
                                ...
                                <input type="text" class="form-control" name="uname" id="username" value="<?php echo $user['username'] ?>">
                                <?php echo (isset($_GET['uname'])) ? $_GET['uname'] : "" ?>
